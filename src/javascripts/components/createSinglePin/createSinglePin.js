...
const pinMaker = (pin) => {
  let domString = '';
  domString += `<div class="col-12 col-sm-9 col-md-6 col-lg-6 col-xl-6 single-pin-container" id="${pin.id}">`;
  domString += '  <div class="p-3">';
  domString += '    <div class="image-overlay dropdown">';
  domString += '       <button class="btn-light dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>';
